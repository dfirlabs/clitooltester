...
# Change PYTHONPATH to include clitooltester module and dependencies.
...
project = "CLIToolTester"
copyright = "The CLIToolTester authors"
version = clitooltester.__version__
release = clitooltester.__version__
...
htmlhelp_basename = "clitooltesterdoc"
...
def RunSphinxAPIDoc(app):
    ...
    module_path = os.path.join(current_directory, "..", "clitooltester")
